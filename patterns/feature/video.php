...
<div class="wp-block-group alignfull"
	...
	<!-- wp:cover {"dimRatio":80,"overlayColor":"neutral-950","isUserOverlayColor":true,"align":"full","style":{"position":{"all":"fixed"},"top":{"all":"0px"},"right":{"all":"0px"},"bottom":{"all":"0px"},"left":{"all":"0px"},"zIndex":{"all":"4"},"display":{"all":"none"}},"className":"video-popup is-style-light","layout":{"type":"constrained","orientation":"horizontal"}} -->
	<div class="wp-block-cover alignfull video-popup is-style-light"><span
			aria-hidden="true"
			class="wp-block-cover__background has-neutral-950-background-color has-background-dim-80 has-background-dim"></span>
		<div class="wp-block-cover__inner-container">
			<!-- wp:group {"align":"full","style":{"position":{"all":"fixed"},"top":{"all":"0px"},"right":{"all":"0px"},"bottom":{"all":"0px"},"left":{"all":"0px"}},"className":"is-style-default","layout":{"type":"constrained"},"onclick":"((event)=\u003e{\n  const popup = document.getElementsByClassName('video-popup')[0] ?? null;\n  \n  if ( popup \u0026\u0026 ! event.target.matches( 'figure *' ) ) {\n    popup.classList.add('has-display-none');\n  }\n})(event);"} -->
			<div class="wp-block-group alignfull is-style-default">
				<!-- wp:group {"style":{"dimensions":{"minHeight":"100%"}},"className":"is-style-light","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","verticalAlignment":"center","flexWrap":"nowrap"}} -->
				<div class="wp-block-group is-style-light"
					 style="min-height:100%">
					<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"right"},"style":{}} -->
					<div class="wp-block-buttons">
						<!-- wp:button {"backgroundColor":"transparent","style":{"spacing":{"padding":{"right":"0","left":"0","top":"0","bottom":"0"}}},"fontSize":"36","onclick":"(()=\u003e{\n  const popup = document.getElementsByClassName('video-popup')[0] ?? null;\n  \n  if ( popup ) {\n    popup.classList.add('has-display-none');\n  }\n})();\n","iconSet":"wordpress","iconName":"close","iconSvgString":"\u003csvg xmlns=\u0022http://www.w3.org/2000/svg\u0022 viewBox=\u00220 0 24 24\u0022 role=\u0022img\u0022 aria-labelledby=\u0022icon-661a7683979b8\u0022 data-icon=\u0022wordpress-close\u0022 width=\u002224\u0022 height=\u002224\u0022 fill=\u0022currentColor\u0022\u003e\u003ctitle id=\u0022icon-661a7683979b8\u0022\u003eClose Icon\u003c/title\u003e\u003cpath d=\u0022m13 11.8 6.1-6.3-1-1-6.1 6.2-6.1-6.2-1 1 6.1 6.3-6.5 6.7 1 1 6.5-6.6 6.5 6.6 1-1z\u0022\u003e\u003c/path\u003e\u003c/svg\u003e"} /--></div>
					<!-- /wp:buttons -->
					...
					<figure
						class="wp-block-video has-primary-300-color has-neutral-950-background-color has-text-color has-background has-link-color"
						style="margin-bottom:var(--wp--preset--spacing--xl)">
						<video controls
							   poster="<?php echo esc_url( content_url( "/themes/adaptify/assets/" ) ) ?>svg/scribbles-30.svg"
							   src="<?php echo esc_url( content_url( "/themes/adaptify/assets/" ) ) ?>video/background.mp4"></video>
					</figure>
					<!-- /wp:video --></div>
				<!-- /wp:group --></div>
			<!-- /wp:group --></div>
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center"
		...
		<div class="wp-block-column is-vertically-aligned-center has-animation"
			...
			<h2 class="wp-block-heading" style="margin-top:0;margin-bottom:0">
				Personalized design and marketing for your business</h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"className":"is-style-sub-heading"} -->
			<p class="is-style-sub-heading">We are a group of people who think
				differently, with a passion for all things digital. Our
				value-driven approach to design and marketing is unique.</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-columns has-20-font-size"
				 style="padding-top:var(--wp--preset--spacing--xs)">
				<!-- wp:column -->
