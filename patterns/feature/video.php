...
<!-- /wp:cover --></div>
<!-- /wp:column -->
<!-- wp:column {"verticalAlignment":"center","width":"50%","style":{"spacing":{"padding":{"left":"var:preset|spacing|sm","right":"var:preset|spacing|sm"}}},"animation":{"name":"fade-in-right","duration":1,"delay":"1"}} -->
<div class="wp-block-column is-vertically-aligned-center has-animation" style="padding-right:var(--wp--preset--spacing--sm);padding-left:var(--wp--preset--spacing--sm);flex-basis:50%;animation-name:fade-in-right;animation-duration:1s;animation-delay:1s;animation-iteration-count:1"><!-- wp:heading {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
